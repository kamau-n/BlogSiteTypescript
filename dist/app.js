...
const expressSession_1 = __importDefault(require("./middleware/expressSession"));
const corsOptions = {
...
app.use(expressSession_1.default);
...
try {
    connection_1.appDataSource.initialize()
        ...
        express_1.response.json({ mg: "unable to connect to server" });
    });
}
catch (err) {
